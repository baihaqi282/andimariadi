...
<?php include "sidebar.php";?>	  
	  <div class="content-wrapper">
          <h3 class="page-heading mb-4">Edit Data Toko</h3>
          <div class="row mb-2">
            <div class="col-lg-10">
              <div class="card">
                <div class="card-body">
				<?php 
$ubah = mysqli_query ($koneksi, "select * from toko where id_toko ='$ud1'");
...
if (isset($_POST['edt'])) {
	...
	$cek = mysqli_query($koneksi, "select * from toko where id_toko='$data[0]'"); //cek data yg mau diedit
	
  if (mysqli_num_rows($cek) !=0) {
		$edit = mysqli_query($koneksi, "UPDATE `toko` set  `nama_toko`='$nama',`id_penyewa`='$np',`id_blok`='$nb',`ukuran`='$ukrn',`harga_sewa`='$hrs' where `id_toko`='$ud1'") 
		or die (mysqli_error());
