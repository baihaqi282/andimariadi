...
?>	
  ...
  <div class="content-wrapper">
      ...
      $tanggal = date('Y-m-d');
       ...
       $sql = mysqli_query($koneksi, "SELECT `jpftu`.`id`,`jpftu`.`tgl`,`jpftu`.`jenis_jpftu`,`jpftu`.`id_`,`jpftu`.`idindeks`,`jpftu`.`bulan`,`jpftu`.`retribusi`,`jpftu`.`denda`,`jpftu`.`total`,`toko`.`nama_toko`,`los`.`nama_los`,`bak`.`nama_peti` FROM `jpftu` LEFT JOIN `toko` ON `jpftu`.`id_` = `toko`.`id_toko`
