          ...
          <div class="row mb-2">
            <div class="col-lg-10">
              <div class="card">
                <div class="card-body">
				<?php
$cari = mysqli_query ($koneksi, "select max(`id_los`) as kd from los");
...
if (isset($_POST['add'])) {
  ...
  if ($id != '') {
		$insert = mysqli_query($koneksi, "INSERT INTO los (`id_los`,`nama_los`,`id_penyewa`,`id_blok`,`ukuran`,`harga_sewa`) 
