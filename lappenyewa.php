...
?>	  
	  <div class="content-wrapper">
          <h3 class="page-heading mb-4">Data Penyewa<small>&nbsp( <?php echo IndonesiaTgl(date('Y-m-d'));?> )</small></h3>
           <div class="row mb-2">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title mb-4" ><a href="penyewa.php"><span class="fa fa-plus">Tambah Data</a><i class="fa fa-bookmark float-right icon-grey-big"></i></span></h5>
